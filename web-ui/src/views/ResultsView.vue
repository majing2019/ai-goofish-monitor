...
<template>
  <div>
    ...
    <ResultsFilterBar
      ...
      v-model:minViewCount="filters.min_view_count"
      v-model:minWantCount="filters.min_want_count"
      v-model:publishWithinDays="filters.publish_within_days"
      v-model:isReplicableOnly="filters.is_replicable_only"
      v-model:minReplicationScore="filters.min_replication_score"
