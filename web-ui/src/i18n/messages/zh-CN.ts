...
const zhCN = {
  ...
  results: {
    ...
    filters: {
      ...
      // F1: 成交量 & 发布时间筛选
      minViewCount: '最低浏览量',
      minViewCountPlaceholder: '不限',
      minWantCount: '最低想要人数',
      minWantCountPlaceholder: '不限',
      publishTime: '发布时间',
      publishAll: '不限',
      publish1Day: '1天内',
      publish3Days: '3天内',
      ...
      publish90Days: '90天内',
      // F2: 复刻可行性筛选
      replicableOnly: '仅看可复刻',
      minReplicationScore: '最低复刻分数',
      minReplicationScorePlaceholder: '不限',
    },
    grid: {
      loading: '正在加载结果...',
      empty: '没有找到符合条件的商品记录。',
    ...
    card: {
      ...
      // F2: 复刻评估
      replicable: '可复刻',
      replicationScore: '复刻分数',
      replicationDetail: '复刻评估',
      feasibility: '技术可行性',
      cost: '一次性成本',
      pricing: '定价空间',
      moat: '竞争壁垒',
