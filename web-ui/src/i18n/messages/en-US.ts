...
const enUS = {
  ...
  results: {
    ...
    filters: {
      ...
      sortByReplicationScore: 'By Replication Score',
      desc: 'Descending',
      asc: 'Ascending',
      ...
      // F1: View & Want count + Publish time filters
      minViewCount: 'Min. Views',
      minViewCountPlaceholder: 'Any',
      minWantCount: 'Min. Wants',
      minWantCountPlaceholder: 'Any',
      publishTime: 'Publish Time',
      publishAll: 'Any',
      publish1Day: 'Within 1 Day',
      publish3Days: 'Within 3 Days',
      publish7Days: 'Within 7 Days',
      publish30Days: 'Within 30 Days',
      publish90Days: 'Within 90 Days',
      // F2: Replication assessment filters
      replicableOnly: 'Replicable Only',
      minReplicationScore: 'Min. Replication Score',
      minReplicationScorePlaceholder: 'Any',
    },
    grid: {
    ...
    card: {
      ...
      block: 'Block',
      unblock: 'Unblock',
      // F2: Replication assessment card
      replicable: 'Replicable',
      replicationScore: 'Replication Score',
      replicationDetail: 'Replication Assessment',
      feasibility: 'Technical Feasibility',
      cost: 'One-time Cost',
      pricing: 'Pricing Space',
